...
const sendMsg = async (routingKey,message ) => {
try{
    ...
    console.log(`Message has sent with Routing Key as ${routingKey} and content as ${message}`);
...
sendMsg("order.placed",{ orderId: 12345 , status: "Placed"});
sendMsg("payment.processed", {paymentId: 67890, status: "processed"});
